...
import java.util.Scanner;
    ...
    public class calculateInterest {
        ...
        public static void main(String[] args) throws FileNotFoundException {
            File f1 = new File("C:\\Users\\misba\\intellij\\java-practice\\src\\com\\sangamone\\Interest.csv");
            ...
            for (int i = 0; i < date2.size(); i++) {
                ...
                interest2.add(interest1);
                intTot+=interest2.get(i);
                //intTot=intTot+interest2;
            }
